...
The input variables $(X1,...,X56)$ are demographic caracteristics of each County.

Here, a county winner prediction can be viewed as a classification rule $g : \mathbb{R}^{57} \rightarrow\{0,1\}$ such that
